  ...
  return <main>
    ...
    <section className="contact-page wrap">
      ...
      <div className="contact-panel">
        ...
        <a href="mailto:eokim002@gmail.com" className="email-big">eokim002@gmail.com <ArrowUpRight/></a>
        <button onClick={copy} className="copy-button">{copied ? <><Check size={16}/> Copied!</> : <><Copy size={16}/> Copy email</>}</button>
        <div className="contact-links">
          <a href="https://www.linkedin.com/in/eokim002/" target="_blank" rel="noreferrer"><UserRound/><span>LinkedIn<small>Connect professionally</small></span><ArrowUpRight/></a>
          <a href="https://drive.google.com/file/d/1217wGnPp_2ZPg1xSuei8SWV_cGzKsZ8V/view?usp=sharing" target="_blank" rel="noreferrer"><FileText/><span>Resume<small>View experience &amp; skills</small></span><ArrowUpRight/></a>
        </div>
      </div>
    </section>
    <BuildCredit/>
